  ...
  return (
    <S.Footer>
      ...
      <S.DisclaimerSection>
        ...
        <p>#1 Most Loved Banking App Source: Chime received the highest 2021 Net Promoter Score among competitors in the industry according to Qualtrics®. Chime was the 2021 #1 most downloaded banking app in the US according to Apptopia®.</p>
        ...
        <p><sup>2</sup> Early access to direct deposit funds depends on the timing of the submission of the payment file from the payer. We generally make these funds available on the day the payment file is received, which may be up to 2 days earlier than the scheduled payment date.</p>
        <p><sup>3</sup> Out-of-network ATM withdrawal fees apply except at MoneyPass ATMs in a 7-Eleven location or any Allpoint or Visa Plus Alliance ATM. Other fees such as third-party and cash deposit fees may apply.</p>
        <p><sup>4</sup> Based on a representative study conducted by Experian®, members who made their first purchase with Credit Builder between June 2020 and October 2020 observed an average FICO® Score 8 increase of 30 points after approximately 8 months. On-time payment history can have a positive impact on your credit score. Late payment may negatively impact your credit score.</p>
        <p><sup>5</sup> To be eligible to apply for Credit Builder, you need to have received a qualifying direct deposit of $200 or more to your Spending Account within the last 365 days of your application. The qualifying direct deposit must have been made by your employer, payroll provider, or benefits payer by Automated Clearing House (ACH) deposit. Bank ACH transfers, Pay Friends transfers, verification or trial deposits from financial institutions, peer to peer transfers from services such as PayPal, Cash App, or Venmo, mobile check deposits, and cash loads or deposits are not qualifying direct deposits.</p>
        <p><sup>6</sup> Sometimes instant transfers can be delayed. The recipient must use a valid debit card to claim funds. Once you are approved for a Chime Checking Account, see your issuing bank&apos;s Deposit Account Agreement for full Pay Anyone Transfers details. Please see the back of your Chime debit card for your issuing bank. See Terms and Conditions</p>
        <p><sup>7</sup> The Annual Percentage Yield (&quot;APY&quot;) for the Chime Savings Account is variable and may change at any time. The disclosed APY is accurate as of August 25th, 2022. No minimum balance required. Must have $0.01 in savings to earn interest.</p>
        <p>Licenses<br />Chime Capital, LLC, Nationwide Multistate Licensing System (&quot;NMLS&quot;) ID 2316451</p>
